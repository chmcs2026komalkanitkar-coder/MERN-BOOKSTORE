...
const handleDelete = async() =>{
  ...
  <>
    ...
    <p className="font-medium text-base-content lin-clamp-1">
    {book.title}
    </p>
      </div>
    ...
    <div className="tooltip tooltip-warning" data-tip="Edit book">
      <Edit2 className="size-4 text-warning hover:scale-110
    transition" />
  ...
  <button className="btn btn-error flex items-center gap-2" onClick={handleDelete}> <Trash2 className="size-4"/>Delete
  </button>
  </div>
  </div>
  </dialog>)}
