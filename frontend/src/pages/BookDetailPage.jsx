...
import{LoaderIcon, Trash2Icon,ArrowLeftIcon, ArrowRight} from "lucide-react";
...
const BookDetailPage = () => {
  ...
  useEffect(()=>{
    const fetchBook = async() =>{
      try{
        ...
        console.eroor("Error fetching book",error);
  ...
  const handleSave= async()=>{
    if(!book.title.trim() || !book.author.trim()|| !book.publishYear){
      toast.error("Please add title and author and publishYear");
      return;
    }
    setSaving(true);
